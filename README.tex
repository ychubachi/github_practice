...
\subsubsection{リポジトリへの変更内容の確認}
\label{sec-1-3-9}
\begin{itemize}
\item 次のコマンドで現在のディレクトリで行った変更内容が確認できる
\begin{itemize}
\item これを差分ともいう
\end{itemize}
\end{itemize}
...
\subsubsection{ステージングはコミットの一歩手前}
\label{sec-1-3-10}
...
\begin{itemize}
\item 本来，にブランチは「これから行う作業の内容」が分かるような名前を付ける
\end{itemize}
