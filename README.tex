...
\subsubsection{{\bfseries\sffamily TODO} Gitを用いた開発の流れ}
\label{sec-2-3-1}
\begin{itemize}
\item Git-flow
\begin{itemize}
...
\subsubsection{GitHub Flowによる協同開発}
\label{sec-2-3-2}
\begin{enumerate}
...
\item レビュー＆自動テスト
\item GitHubでブランチをmasterマージ
\item ローカルでmasterを最新にする（2.に戻る）
\end{enumerate}
